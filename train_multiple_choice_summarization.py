...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/summarization", help="Where to store the final model.")
...
def main():
    ...
    if args.dataset_name is not None:
        ...
        # raw_datasets = datasets.DatasetDict.from_json({"train": args.train_file, "validation": args.validation_file})
    ...
    # {'rouge1': 13.0614, 'rouge2': 4.8682, 'rougeL': 12.9087, 'rougeLsum': 12.9247}
    best_epoch = None
    best_rouge1 = 0

    # save each epoch prediction in output_dir
    # then copy the best epoch prediction jsonl file
    pred_dir = args.output_dir / "prediction"
    pred_dir.mkdir(parents=True, exist_ok=True)
    record_path = args.output_dir / "record.csv"
    record_str = "epoch,rouge1,rouge2,rougeL,rougeLsum\n"
